package com.wallethub.UIAutomation.WalletHubProfileUiAutomation.TestBase;
...
public class TestBase {
	...
	public String getScreenShot(String screenshotName) {
		...
		try {
			...
			String reportDirectory = new File(System.getProperty("user.dir"))
					.getAbsolutePath()
					+ "\\src\\main\\java\\com\\wallethub\\UIAutomation\\WalletHubProfileUiAutomation\\ScreenShots\\";
	...
	public List<WebElement> waitForTheWebElements(List<WebElement >dropDownList,
			WebDriver driver, long time) {

		WebDriverWait wait = new WebDriverWait(driver, time);

		return wait.until(ExpectedConditions.visibilityOfAllElements(dropDownList));
	...
	public static void loadProperties() throws IOException {
		prop = new Properties();
		file = new File(System.getProperty("user.dir")+ "\\src\\main\\java\\com\\wallethub\\UIAutomation\\WalletHubProfileUiAutomation\\properties\\credential.properties");
	...
	public String readTextFile() throws IOException{
		String FILENAME=System.getProperty("user.dir")+"\\src\\main\\java\\com\\wallethub\\UIAutomation\\WalletHubProfileUiAutomation\\properties\\ReviewComments.text";
